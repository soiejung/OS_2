...
#define L1dINFO "/sys/devices/system/cpu/cpu0/cache/index0/size" // /L1d size 절대 경로
#define L1iINFO "/sys/devices/system/cpu/cpu0/cache/index1/size" // /L1i size 절대 경로
#define L2INFO "/sys/devices/system/cpu/cpu0/cache/index2/size" // /L2 size 절대 경로
#define L3INFO "/sys/devices/system/cpu/cpu0/cache/index3/size" // /L3 size 절대 경로
